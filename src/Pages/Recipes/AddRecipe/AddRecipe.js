...
const AddRecipe = () => {
  ...
  const submitData = (e) => {
    e.preventDefault();
    setIsSending(true);
    // axios.post("//laurielim-thecocktailapp-api.herokuapp.com/add", data)
    ...
    <div className="container add-recipe">
      ...
      {showAlert && (
        ...
        >
          ...
          <p>
            Or at least it would have been if the API was still up.
            Unfortunately I had to take it down so no new recipe can be added.
            Thanks for tring out the form though.
          </p>
        </Alert>
      )}
